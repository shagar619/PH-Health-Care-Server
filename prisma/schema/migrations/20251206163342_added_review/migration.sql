...
-- CreateTable
CREATE TABLE "patient_health_dates" (
    "id" TEXT NOT NULL,
    "patientId" TEXT NOT NULL,
    ...
    CONSTRAINT "patient_health_dates_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "patient_health_dates_patientId_key" ON "patient_health_dates"("patientId");
...
-- AddForeignKey
ALTER TABLE "patient_health_dates" ADD CONSTRAINT "patient_health_dates_patientId_fkey" FOREIGN KEY ("patientId") REFERENCES "patients"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
